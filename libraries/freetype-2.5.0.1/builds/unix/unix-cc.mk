...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -DDARWIN_NO_CARBON -DFT_CONFIG_OPTION_SYSTEM_ZLIB -DFT_CONFIG_OPTION_USE_BZIP2 -I/opt/X11/include/libpng15 -DFT_CONFIG_OPTION_USE_PNG -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS :=  -lz -lbz2 -L/opt/X11/lib -lpng15
